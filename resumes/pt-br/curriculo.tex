    ...
    \section{Resumo} 
        ...
        Engenheiro DevOps/SRE com 4 anos de experiência, especializado em ambientes de alta disponibilidade e modernização de infraestrutura em nuvem. Expertise nos ecossistemas Azure, AWS, Kubernetes, Observabilidade, CI/CD, Terraform, Ansible. Histórico comprovado de refatoração de arquiteturas para ganhos de performance, escalabilidade e otimização de custos.
    ...
    \section{Habilidades}
        ...
        \begin{itemize}
            ...
            \item \textbf{Soft Skills:} Mentoria, resolução de problemas técnicos, comunicação clara com clientes e gerência .
            \item \textbf{Idiomas:} Português (Nativo), Inglês (B2 - Intermediário Superior)
        \end{itemize}
